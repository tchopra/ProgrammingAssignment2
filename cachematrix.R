...
makeCacheMatrix <- function(x = matrix()) {
        ...
        get <- function() x ## get() function will retun the parent object.
        setSolve <- function(Solve) m <<- Solve ## setSolve() function will store the inverse of matrix that is passed in the  the cache (m).
